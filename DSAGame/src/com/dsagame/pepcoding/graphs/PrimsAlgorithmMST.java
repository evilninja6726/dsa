...
public class PrimsAlgorithmMST {
    ...
    public static void prims(int n, ArrayList<Edges>[] graph) {
        ...
        priorityQueue.offer(new Triplet(0, -1, 0));
        ...
        while (!priorityQueue.isEmpty()) {
            ...
            if (top.parent != -1) {
                System.out.println(top.vertex + "@" + top.parent + "@" + top.weight);
            }
            for (Edges edges : graph[top.vertex]) {
                if (!isVisited[edges.d]) {
                    priorityQueue.offer(new Triplet(edges.d, top.vertex, edges.w));
                }
            }
        }
    }
    ...
    private static class Triplet {
        ...
        public Triplet(int vertex, int parent, int weight) {
            this.vertex = vertex;
            this.parent = parent;
            this.weight = weight;
        }
