...
public class IterativeDfs {
    public static void main(String[] args) {
        ...
        iterativeDfs(n, graph);
    }

    public static void iterativeDfs(int n, ArrayList<Edges>[] graph) {
        ...
        while (!stack.isEmpty()) {
            ...
            System.out.println(top.vertex + "@" + top.pathSoFar);
            for (Edges edges : graph[top.vertex]) {
                if (!isVisited[edges.d]) {
                    stack.push(new Pair(edges.d, top.pathSoFar + edges.d));
                }
            }
        }
    }
